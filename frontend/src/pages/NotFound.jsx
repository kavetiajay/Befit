...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#09090b] text-slate-800 dark:text-zinc-100 flex flex-col justify-center items-center p-6 font-sans">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-400 dark:text-zinc-400 font-semibold max-w-sm mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-6">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 text-slate-700 dark:text-zinc-300 font-bold text-xs rounded-xl shadow-sm hover:bg-slate-50 dark:hover:bg-zinc-800 active:scale-95 transition cursor-pointer"
          >
