...
const GoogleIcon = () => (
  ...
  >
    <g transform="matrix(1, 0, 0, 1, 0, 0)">
      <path
        d="M21.35,11.1H12v2.7h5.38c-0.24,1.28 -0.96,2.37 -2.04,3.1v2.6h3.3c1.93,-1.78 3.04,-4.4 3.04,-7.4C21.68,11.75 21.56,11.4 21.35,11.1z"
        fill="#4285F4"
      />
      <path
        d="M12,20.6c2.43,0 4.47,-0.8 5.96,-2.2l-3.3,-2.6c-0.9,0.6 -2.07,0.98 -3.26,0.98 -2.33,0 -4.3,-1.58 -5,-3.7H3v2.6C4.5,18.7 8,20.6 12,20.6z"
        fill="#34A853"
      />
      <path
        d="M7,13.08c-0.18,-0.54 -0.28,-1.1 -0.28,-1.68s0.1,-1.14 0.28,-1.68V7.1H3C2.36,8.38 2,9.85 2,11.4s0.36,3.02 1,4.3L7,13.08z"
        fill="#FBBC05"
      />
      <path
        d="M12,6.22c1.32,0 2.5,0.45 3.44,1.35l2.58,-2.58C16.46,3.52 14.42,2.6 12,2.6 8,2.6 4.5,4.5 3,7.6v2.6l5,-3.7C8.7,4.32 10.67,6.22 12,6.22z"
        fill="#EA4335"
      />
    </g>
  </svg>
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // BEFIT LOGIN ROUTING
      //
      // trainee@gmail.com -> TRAINER
      // Any other email    -> CLIENT
      // =========================================================
      const isTrainer =
        normalizedEmail === "trainee@gmail.com";

      const portalRole = isTrainer ? "trainer" : "client";
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      ...
      toast.success(
        "Google Authentication Simulated! Future Integration Ready."
      );
    }, 1500);
  };
        ...
        <div className="w-full max-w-[500px] bg-white dark:bg-zinc-900/60 border border-slate-100 dark:border-zinc-800/80 shadow-[0_20px_50px_rgba(59,130,246,0.06)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-md rounded-[20px] p-8 sm:p-12 animate-in fade-in zoom-in-95 duration-500 transition-all login-card-container">
          ...
          <div className="relative flex items-center justify-center my-6">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-slate-100 dark:border-zinc-800/80" />
            </div>
              ...
              <div className="flex flex-col items-center text-center py-4 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-400 dark:text-zinc-500 font-bold leading-relaxed max-w-sm">
                    ...
                    <span className="text-slate-700 dark:text-zinc-200 font-extrabold">
                      {forgotEmail}
                    </span>
